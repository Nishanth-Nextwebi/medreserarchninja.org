...
public class MemberDetails
{
    ...
    public static List<MemberDetails> GetFilteredMembersDetails(SqlConnection _con, string key, string sdate, string edate, string status, string pstatus)
    {
        ...
        try
        {
            ...
            string query = "Select * from MemberDetails md where Status !='Deleted' AND (@key =''  OR md.FullName Like '%'+@Key+'%' OR md.Contact Like '%'+@Key+'%' OR md.EmailId Like '%'+@Key+'%') " + querypart + @"  Order by id desc";
