<%@ Page Title="Med Research Ninja | View Projects" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="view-projects.aspx.cs" Inherits="Admin_view_projects" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <table id="alternative-pagination" class="table align-middle table-striped table-bordered myTable" style="width: 100%">
                                <thead class="">
                                    <tr>
                                        <th>#</th>
                                        <th>Project Code</th>
                                        <th class='maxWidth'>Project Name</th>
                                        <th>Whatsapp</th>
                                        <th>Subject</th>
                                        <th>MaxCollab</th>
                                        <th>PriceINR</th>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="WhitePaperModalLabel">Projects Details</h5>
    ...
    <script src="assets/js/pages/view-projects1.js"></script>
</asp:Content>
