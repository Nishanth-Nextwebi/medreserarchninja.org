                        ...
                        <div class="card-body">
                            <div class="row gy-4">
                                <div class="col-lg-4">
                                    ...
                                    <asp:TextBox runat="server" class="form-control mb-2 mr-sm-2 txtName" ID="txtTitle" placeholder="Notice Title" MaxLength="100" />
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <asp:TextBox runat="server" class="form-control mb-2 mr-sm-2 txtName" ID="txtNoticeUrl" placeholder="Notice URL" MaxLength="100" />
