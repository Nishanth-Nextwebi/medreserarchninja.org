<%@ Page Title="" Language="C#" MasterPageFile="./User.master" AutoEventWireup="true" CodeFile="my-payment.aspx.cs" Inherits="my_payment" %>
            ...
            <div class="dashboard__sidebar d-none d-lg-block">
                <div class="dashboard_sidebar_list">
                    ...
                    <div class="sidebar_list_item position-relative">
                        <a href="my-payment.aspx" class="items-center -is-active"><i class="flaticon-receipt mr15"></i>Projects Due</a><%= strDues %>
                    </div>
...
<i class="flaticon-logout mr15"></i>Logout 
                            ...
                            <div class="ps-widget bgc-white bdrs4 p30 mb30 overflow-hidden position-relative">
                                <div class="bdrb1 pb15 mb25">
                                    <h5 class="list-title fw-bold">Payment Details</h5>
                                </div>
                                <div class="col-lg-12">
                                            ...
                                            <table class="table-style3 table at-savesearch">
                                                <thead class="t-head">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="pName">Project Name</th>
